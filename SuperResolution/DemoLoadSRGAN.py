...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 16 22:52:13 2021
...
if __name__=='__main__':
    ...
    # pyplot.savefig('Initial_Result.png',dpi=1000)
    # pyplot.savefig('Initial_Result.svg',dpi=1000)
    ...
    ax.set_xlabel('Position (m)')
    ax.set_ylabel('Depth (m)') 
    # pyplot.savefig('Bicubic_Result.png',dpi=1000)
    # pyplot.savefig('Bicubic_Result.svg',dpi=1000)
    ...
    ax.set_xlabel('Position (m)')
    ax.set_ylabel('Depth (m)') 
    # pyplot.savefig('SRGAN_Result.png',dpi=1000)
    # pyplot.savefig('SRGAN_Result.svg',dpi=1000)
    ...
    pyplot.plot(np.linspace(0,1870,187),vp_10Hz_line,'g:')
    pyplot.plot(np.linspace(0,1870,187),Bicubic_line,'b-.')
    pyplot.plot(np.linspace(0,1870,187),SRGAN_line,'r-')
    ...
    pyplot.savefig('New_SR_Line_Result.png',dpi=1000)
    # pyplot.savefig('SR_Line_Result.svg',dpi=1000)
