...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 24 19:51:27 2021
...
if __name__=='__main__':
    ...
    HR_Image=np.load('./20Hz_Marmousi.npy')
    HR_Image=HR_Image.reshape((190,-1))
    HR_Image=HR_Image[20:-20,20:-20]
    HR_Image=skimage.transform.resize(HR_Image,output_shape=(300,1000),mode='symmetric')
    
    LR_Image=np.load('./20Hz_Marmousi.npy')
    LR_Image=LR_Image.reshape((190,-1))
