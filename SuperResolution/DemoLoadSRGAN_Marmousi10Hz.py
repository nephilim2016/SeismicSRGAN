...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 23 21:03:07 2021
...
if __name__=='__main__':
    ...
    HR_Image=np.load('./10Hz_Marmousi.npy')
    HR_Image=HR_Image.reshape((115,-1))
    HR_Image=HR_Image[20:-20,20:-20]
    HR_Image=skimage.transform.resize(HR_Image,output_shape=(150,500),mode='symmetric')
