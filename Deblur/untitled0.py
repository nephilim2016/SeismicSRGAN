...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 23 17:16:14 2021
...
if __name__=='__main__':
    ...
    Blur_Image=np.load('20Hz.npy')
    # Blur_Image=denoising_2D_TV(Blur_Image)
    Blur_Image=Blur_Image.reshape((240,-1))
    Blur_Image=Blur_Image[33:-20,20:-20]
    ...
    PredictData=Modified_TV.denoising_2D_TV(PredictData)
    PredictData=Modified_TV.denoising_2D_TV(PredictData)
    PredictData=Modified_TV.denoising_2D_TV(PredictData)
    PredictData=Modified_TV.denoising_2D_TV(PredictData)
    ...
    # pyplot.savefig('20Hz_Blur_Result.png',dpi=1000)
    ...
    ax.set_xlabel('Position (m)')
    ax.set_ylabel('Depth (m)') 
    # pyplot.savefig('20Hz_Deblur_Result.png',dpi=1000)
    ...
    ax.invert_yaxis()
    ax.set(aspect=3)
    pyplot.legend(['True Model','without Resolution Enhancement Regularization','with Resolution Enhancement Regularization'],frameon=False)
    ax.set_xlabel('Velocity (m/s)')
    ax.set_ylabel('Depth (m)') 
    # pyplot.savefig('20Hz_Deblur_1D_Line.png',dpi=1000)
